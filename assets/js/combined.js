!(function (t, e) {
  ...
  function l(t, e, i) {
    ...
    if (void 0 === i && 1 === t.nodeType)
      if (
        ((n = "data-" + e.replace(It, "-$&").toLowerCase()), (i = t.getAttribute(n)), "string" == typeof i)
      ) {
        try {
          i =
            "true" === i ||
            ("false" !== i && ("null" === i ? null : +i + "" === i ? +i : At.test(i) ? ot.parseJSON(i) : i));
        } catch (t) {}
        St.set(t, e, i);
      } else i = void 0;
    return i;
  ...
  function v(t, e) {
    return ot.nodeName(t, "table") && ot.nodeName(11 !== e.nodeType ? e : e.firstChild, "tr")
        ...
        for (h = s[s.length - 1].ownerDocument, ot.map(s, _), c = 0; a > c; c++)
          (l = s[c]),
            Rt.test(l.type || "") &&
              ...
              ot.contains(h, l) &&
              (l.src ? ot._evalUrl && ot._evalUrl(l.src) : ot.globalEval(l.textContent.replace(Ut, "")));
    }
    return t;
  }
  function w(t, e, i) {
    for (var n, r = e ? ot.filter(e, t) : t, o = 0; null != (n = r[o]); o++)
      i || 1 !== n.nodeType || ot.cleanData(u(n)),
        n.parentNode &&
          (i && ot.contains(n.ownerDocument, n) && c(u(n, "script")), n.parentNode.removeChild(n));
    return t;
  }
  function E(t, e) {
  ...
  function C(t) {
    ...
    return (
      i ||
        ((i = E(t, e)),
        ("none" !== i && i) ||
          (($t = ($t || ot("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement)),
      ...
      "margin" === i && (s += ot.css(t, i + kt[o], !0, r)),
        n
          ? ("content" === i && (s -= ot.css(t, "padding" + kt[o], !0, r)),
            "margin" !== i && (s -= ot.css(t, "border" + kt[o] + "Width", !0, r)))
          : ((s += ot.css(t, "padding" + kt[o], !0, r)),
            "padding" !== i && (s += ot.css(t, "border" + kt[o] + "Width", !0, r)));
    return s;
  }
  function k(t, e, i) {
    var n = !0,
        ...
        n.style &&
          ...
          e
            ? (o[s] || "none" !== i || (n.style.display = ""),
              "" === n.style.display && Ot(n) && (o[s] = Ct.access(n, "olddisplay", C(n.nodeName))))
            : ((r = Ot(n)), ("none" === i && r) || Ct.set(n, "olddisplay", r ? i : ot.css(n, "display"))));
    for (s = 0; a > s; s++)
      (n = t[s]),
        n.style &&
  ...
  function z(t, e, i) {
    ...
    i.queue ||
      ...
      1 === t.nodeType &&
        ...
        "inline" === u && "none" === ot.css(t, "float") && (d.display = "inline-block")),
      i.overflow &&
        ((d.overflow = "hidden"),
        c.always(function () {
    ...
    if (ot.isEmptyObject(f)) "inline" === ("none" === h ? C(t.nodeName) : h) && (d.display = h);
      ...
      for (n in f)
        (s = M(p ? m[n] : 0, n, c)),
          n in m ||
            ((m[n] = s.start), p && ((s.end = s.start), (s.start = "width" === n || "height" === n ? 1 : 0)));
    }
  }
  function j(t, e) {
    var i, n, r, o, s;
  ...
  (ot.fn = ot.prototype =
    ...
    ot.extend({
      ...
      each: function (t, e) {
        var n,
          r = 0;
        if (i(t)) for (n = t.length; n > r && e.call(t[r], r, t[r]) !== !1; r++);
      ...
      map: function (t, e, n) {
        var r,
          ...
          s = 0,
          a = [];
        if (i(t)) for (r = t.length; r > s; s++) (o = e(t[s], s, n)), null != o && a.push(o);
      ...
      if (!n && ((e ? e.ownerDocument || e : W) !== O && k(e), (e = e || O), N)) {
        ...
        if (T.qsa && !U[t + " "] && (!R || !R.test(t))) {
          if (1 !== m) (p = e), (d = t);
            ...
            for (
              (a = e.getAttribute("id")) ? (a = a.replace(_t, "\\$&")) : e.setAttribute("id", (a = F)),
                c = C(t),
                o = c.length,
                l = ft.test(a) ? "#" + a : "[id='" + a + "']";
              o--;
        ...
        if ((i = x.relative[t[a].type])) u = [d(p(u), i)];
          ...
          if (((i = x.filter[t[a].type].apply(null, t[a].matches)), i[F])) {
            ...
            return v(
              a > 1 && p(u),
              a > 1 &&
                f(t.slice(0, a - 1).concat({ value: " " === t[a - 2].type ? "*" : "" })).replace(at, "$1"),
              i,
              n > a && y(t.slice(a, n)),
              r > n && y((t = t.slice(n))),
              r > n && f(t)
    ...
    (T = e.support = {}),
      ...
      (e.matchesSelector = function (t, i) {
        if (
          ...
          (i = i.replace(ut, "='$1']")),
          T.matchesSelector && N && !U[i + " "] && (!M || !M.test(i)) && (!R || !R.test(i)))
        )
          try {
            var n = z.call(t, i);
      ...
      (x = e.selectors =
        {
          ...
          pseudos: {
            ...
            focus: function (t) {
              return (
                t === O.activeElement && (!O.hasFocus || O.hasFocus()) && !!(t.type || t.href || ~t.tabIndex)
              );
            },
            enabled: function (t) {
              return t.disabled === !1;
      ...
      (C = e.tokenize =
        function (t, i) {
          ...
          for (a = t, l = [], h = x.preFilter; a; ) {
            (n && !(r = lt.exec(a))) || (r && (a = a.slice(r[0].length) || a), l.push((o = []))),
              (n = !1),
              (r = ht.exec(a)) &&
                ((n = r.shift()), o.push({ value: n, type: r[0].replace(at, " ") }), (a = a.slice(n.length)));
            for (s in x.filter)
              !(r = dt[s].exec(a)) ||
                (h[s] && !(r = h[s](r))) ||
        ...
        function (t, e, i, n) {
          ...
          if (((i = i || []), 1 === c.length)) {
            ...
            for (r = dt.needsContext.test(t) ? 0 : o.length; r-- && ((s = o[r]), !x.relative[(a = s.type)]); )
              if (
                (l = x.find[a]) &&
                (n = l(s.matches[0].replace(bt, Tt), (yt.test(o[0].type) && u(e.parentNode)) || e))
              ) {
  ...
  var gt,
    ...
    yt = (ot.fn.init = function (t, e, i) {
      ...
      if (((i = i || gt), "string" == typeof t)) {
        if (
          ((n = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : vt.exec(t)),
          !n || (!n[1] && e))
        )
        ...
        if (n[1]) {
          if (
            ...
            ot.merge(this, ot.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : G, !0)),
      ...
      function (t, e) {
        ot.fn[t] = function (i, n) {
          ...
          return (
            ...
            this.length > 1 && (bt[t] || ot.uniqueSort(r), _t.test(t) && r.reverse()),
            this.pushStack(r)
          );
        };
      }
                  ...
                  ot.each(e, function (e, o) {
                    ...
                    r[o[1]](function () {
                      ...
                      t && ot.isFunction(t.promise)
                        ...
                        : i[o[0] + "With"](this === n ? i.promise() : this, s ? [t] : arguments);
                    });
                  }),
                    (t = null);
                })
        ...
        if (s > 1)
          for (e = new Array(s), i = new Array(s), n = new Array(s); s > r; r++)
            o[r] && ot.isFunction(o[r].promise)
              ? o[r].promise().progress(h(r, i, e)).done(h(r, n, o)).fail(l.reject)
              : --a;
    ...
    ot.extend({
      ...
      ready: function (t) {
        (t === !0 ? --ot.readyWait : ot.isReady) ||
          ...
          (t !== !0 && --ot.readyWait > 0) ||
            (xt.resolveWith(G, [ot]),
            ot.fn.triggerHandler && (ot(G).triggerHandler("ready"), ot(G).off("ready"))));
      },
    }),
    ...
    (a.prototype = {
      register: function (t, e) {
        ...
        return (
          t.nodeType
            ? (t[this.expando] = i)
            : Object.defineProperty(t, this.expando, { value: i, writable: !0, configurable: !0 }),
          t[this.expando]
        );
      },
      cache: function (t) {
      ...
      access: function (t, e, i) {
        ...
        return void 0 === e || (e && "string" == typeof e && void 0 === i)
          ? ((n = this.get(t, e)), void 0 !== n ? n : this.get(t, ot.camelCase(e)))
        ...
        if (void 0 !== o) {
          if (void 0 === e) this.register(t);
            ...
            ot.isArray(e)
              ...
              : ((r = ot.camelCase(e)),
                e in o ? (n = [e, r]) : ((n = r), (n = n in o ? [n] : n.match(Tt) || []))),
              (i = n.length);
            for (; i--; ) delete o[n[i]];
          }
        ...
        if (void 0 === t) {
          if (this.length && ((r = St.get(o)), 1 === o.nodeType && !Ct.get(o, "hasDataAttrs"))) {
            for (i = s.length; i--; )
              s[i] &&
                ((n = s[i].name),
                0 === n.indexOf("data-") && ((n = ot.camelCase(n.slice(5))), l(o, n, r[n])));
    ...
    ot.extend({
      queue: function (t, e, i) {
        ...
        return t
          ? ((e = (e || "fx") + "queue"),
            (n = Ct.get(t, e)),
            i && (!n || ot.isArray(i) ? (n = Ct.access(t, e, ot.makeArray(i))) : n.push(i)),
            n || [])
          : void 0;
      },
  ...
  (ot.event = {
      ...
      if (g && (l = g.events)) {
        for (e = (e || "").match(Tt) || [""], h = e.length; h--; )
          if (((a = Wt.exec(e[h]) || []), (d = m = a[1]), (p = (a[2] || "").split(".").sort()), d)) {
            ...
            s &&
              !f.length &&
              ((c.teardown && c.teardown.call(t, p, g.handle) !== !1) || ot.removeEvent(t, d, g.handle),
              delete l[d]);
    ...
    dispatch: function (t) {
      ...
      if (((a[0] = t), (t.delegateTarget = this), !h.preDispatch || h.preDispatch.call(this, t) !== !1)) {
        for (s = ot.event.handlers.call(this, t, l), e = 0; (r = s[e++]) && !t.isPropagationStopped(); )
          for (t.currentTarget = r.elem, i = 0; (o = r.handlers[i++]) && !t.isImmediatePropagationStopped(); )
            (t.rnamespace && !t.rnamespace.test(o.namespace)) ||
              ((t.handleObj = o),
              (t.data = o.data),
              (n = ((ot.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, a)),
          ...
          if (1 === l.nodeType && (l.disabled !== !0 || "click" !== t.type)) {
            for (n = [], i = 0; a > i; i++)
              (o = e[i]),
                (r = o.selector + " "),
                void 0 === n[r] &&
                  (n[r] = o.needsContext ? ot(r, this).index(l) > -1 : ot.find(r, this, null, [l]).length),
                n[r] && n.push(o);
    ...
    fix: function (t) {
      ...
      var e,
        ...
        s = this.fixHooks[r];
      for (
        s || (this.fixHooks[r] = s = Ft.test(r) ? this.mouseHooks : jt.test(r) ? this.keyHooks : {}),
        ...
        ? (t && t.type
            ? ((this.originalEvent = t),
              ...
              (this.isDefaultPrevented =
                t.defaultPrevented || (void 0 === t.defaultPrevented && t.returnValue === !1) ? d : p))
            : (this.type = t),
          e && ot.extend(this, e),
  ...
  ot.extend({
    ...
    clone: function (t, e, i) {
      ...
      if (e)
        if (i) for (o = o || u(t), s = s || u(a), n = 0, r = o.length; r > n; n++) b(o[n], s[n]);
        else b(t, a);
  ...
  ot.extend({
        ...
        return (
          ...
          void 0 === i
            ? s && "get" in s && void 0 !== (r = s.get(t, !1, n))
              ...
              : l[e]
            : ((o = typeof i),
              "string" === o && (r = Pt.exec(i)) && r[1] && ((i = h(t, e, r)), (o = "number")),
              void (
                null != i &&
                i === i &&
                ("number" === o && (i += (r && r[3]) || (ot.cssNumber[a] ? "" : "px")),
    ...
    css: function (t, e, i, n) {
      ...
      return (
        ...
        "" === i || i ? ((o = parseFloat(r)), i === !0 || isFinite(o) ? o || 0 : r) : r
      );
    },
  }),
    ot.each(["height", "width"], function (t, e) {
      ot.cssHooks[e] = {
        ...
        set: function (t, i, n) {
          ...
          return (
            s && (r = Pt.exec(i)) && "px" !== (r[3] || "px") && ((t.style[e] = i), (i = ot.css(t, e))),
            D(t, i, s)
          );
        },
      };
      ...
      run: function (t) {
        ...
        return (
          this.options.duration
            ? (this.pos = e =
                ot.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration))
            : (this.pos = e = t),
    ...
    (L.propHooks = {
      _default: {
        ...
        set: function (t) {
          ot.fx.step[t.prop]
            ? ot.fx.step[t.prop](t)
            : 1 !== t.elem.nodeType || (null == t.elem.style[ot.cssProps[t.prop]] && !ot.cssHooks[t.prop])
            ? (t.elem[t.prop] = t.now)
        ...
        return (
          ...
          this.each(function () {
            var e,
              ...
              s = n ? n.length : 0;
            for (
              i.finish = !0, ot.queue(this, t, []), r && r.stop && r.stop.call(this, !0), e = o.length;
              e--;
  ...
  ot.fn.extend({
      ...
      attr: function (t, e, i) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return "undefined" == typeof t.getAttribute
            ? ot.prop(t, e, i)
            : ((1 === o && ot.isXMLDoc(t)) ||
                ((e = e.toLowerCase()), (r = ot.attrHooks[e] || (ot.expr.match.bool.test(e) ? le : void 0))),
              void 0 !== i
                ? null === i
    ...
    ot.each(ot.expr.match.bool.source.match(/\w+/g), function (t, e) {
      ...
      he[e] = function (t, e, n) {
        var r, o;
        return (
          n || ((o = he[e]), (he[e] = r), (r = null != i(t, e, n) ? e.toLowerCase() : null), (he[e] = o)), r
        );
      };
    });
        ...
        : this.each(function () {
            ...
            if ("string" === i)
              ...
              (void 0 !== t && "boolean" !== i) ||
                ...
                this.setAttribute &&
                  this.setAttribute("class", e || t === !1 ? "" : Ct.get(this, "__className__") || ""));
          });
    },
    hasClass: function (t) {
      var e,
      ...
      return arguments.length
        ...
        ? ((e = ot.valHooks[r.type] || ot.valHooks[r.nodeName.toLowerCase()]),
          e && "get" in e && void 0 !== (i = e.get(r, "value"))
            ? i
            : ((i = r.value), "string" == typeof i ? i.replace(de, "") : null == i ? "" : i))
        : void 0;
    },
  }),
    ot.extend({
          ...
          get: function (t) {
            for (
              ...
              if (
                ((i = n[l]),
                (i.selected || l === r) &&
                  (nt.optDisabled ? !i.disabled : null === i.getAttribute("disabled")) &&
                  (!i.parentNode.disabled || !ot.nodeName(i.parentNode, "optgroup")))
              ) {
      ...
      if (
        ...
        for (o = 0; (s = f[o++]) && !e.isPropagationStopped(); )
          (e.type = o > 1 ? l : c.bindType || d),
            ...
            u && u.apply(s, i),
            (u = h && s[h]),
            u && u.apply && Et(s) && ((e.result = u.apply(s, i)), e.result === !1 && e.preventDefault());
        return (
          (e.type = d),
          r ||
      ...
      ajax: function (e, i) {
        function n(e, i, n, a) {
          ...
          2 !== b &&
            ...
            g.fireWith(d, [x, w]),
            u && (p.trigger("ajaxComplete", [x, f]), --ot.active || ot.event.trigger("ajaxStop")));
        }
        ...
        if (
          ...
          (x.success = x.done),
          (x.error = x.fail),
          (f.url = ((e || f.url || ge.href) + "").replace(_e, "").replace(Ee, ge.protocol + "//")),
          ...
          try {
            (h.href = f.url),
              (h.href = h.href),
              (f.crossDomain = Ie.protocol + "//" + Ie.host != h.protocol + "//" + h.host);
          } catch (t) {
            f.crossDomain = !0;
          }
        }
        ...
        (u = ot.event && f.global),
          ...
          (o = f.url),
          f.hasContent ||
            (f.data && ((o = f.url += (ye.test(o) ? "&" : "?") + f.data), delete f.data),
            f.cache === !1 &&
              (f.url = be.test(o)
                ? o.replace(be, "$1_=" + ve++)
                : o + (ye.test(o) ? "&" : "?") + "_=" + ve++)),
          f.ifModified &&
            (ot.lastModified[o] && x.setRequestHeader("If-Modified-Since", ot.lastModified[o]),
          ...
          x.setRequestHeader(
            ...
            f.dataTypes[0] && f.accepts[f.dataTypes[0]]
              ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Ae + "; q=0.01" : "")
              : f.accepts["*"]
          );
    ...
    ot.each(["get", "post"], function (t, e) {
      ot[e] = function (t, i, n, r) {
        return (
          ...
          ot.ajax(ot.extend({ url: t, type: e, dataType: r, data: i, success: n }, ot.isPlainObject(t) && t))
        );
      };
    }),
  ...
  ot.ajaxSetup({
      ...
      return a || "jsonp" === e.dataTypes[0]
        ? ((r = e.jsonpCallback = ot.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback),
          a
            ...
            : e.jsonp !== !1 && (e.url += (ye.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
    ...
    (ot.parseHTML = function (t, e, i) {
      ...
      return n
        ? [e.createElement(n[1])]
        : ((n = f([t], e, r)), r && r.length && ot(r).remove(), ot.merge([], n.childNodes));
    });
  var je = ot.fn.load;
  (ot.fn.load = function (t, e, i) {
    ...
    return (
      ...
      ot.isFunction(e) ? ((i = e), (e = void 0)) : e && "object" == typeof e && (r = "POST"),
      s.length > 0 &&
        ot
          ...
          ? ((e = o.documentElement),
            ot.contains(e, n)
              ? ((r = n.getBoundingClientRect()),
                (i = Y(o)),
                { top: r.top + i.pageYOffset - e.clientTop, left: r.left + i.pageXOffset - e.clientLeft })
              : r)
          : void 0;
      },
      position: function () {
          ...
          function (t, n, r) {
            ...
            return void 0 === r
              ? o
                ? o[e]
                : t[n]
              : void (o ? o.scrollTo(i ? o.pageXOffset : r, i ? r : o.pageYOffset) : (t[n] = r));
          },
          t,
          n,
          arguments.length
    ...
    function (t, e, i) {
      ...
      (o.version = "1.19.0"),
            ...
            (t >= d - 1e-7
              ? ((this._totalTime = d),
                ...
                this._yoyo && 0 !== (1 & this._cycle)
                  ...
                  : ((this._time = v), (this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1)),
                this._reversed ||
                  ((n = !0), (r = "onComplete"), (i = i || this._timeline.autoRemoveChildren)),
                0 === v &&
                  (this._initted || !this.vars.lazy || i) &&
                  (this._startTime === this._timeline._duration && (t = 0),
                  (0 > y || (0 >= t && t >= -1e-7) || (y === s && "isPause" !== this.data)) &&
                    y !== t &&
              ...
              ? ((this._totalTime = this._time = this._cycle = 0),
                ...
                0 > t &&
                  ...
                  0 === v &&
                    (this._initted || !this.vars.lazy || i) &&
                    (y >= 0 && (i = !0), (this._rawPrevTime = f = !e || t || y === t ? t : s))),
                this._initted || (i = !0))
        ...
        (o.staggerTo = o.allTo =
          function (t, e, s, a, u, f, d) {
            ...
            for (
              h(t) || ("string" == typeof t && (t = i.selector(t) || t), l(t) && (t = n(t))),
                t = t || [],
      ...
      var f = function (t, e) {
          for (var n = [], r = 0, o = t._first; o; )
            o instanceof i ? (n[r++] = o) : (e && (n[r++] = o), (n = n.concat(f(o, e))), (r = n.length)),
              (o = o._next);
          return n;
        },
      ...
      (o.killAll = function (t, i, n, r) {
        ...
        for (a = 0; h > a; a++)
          (s = l[a]),
            (u || s instanceof e || ((o = s.target === s.vars.onComplete) && n) || (i && !o)) &&
          ...
          (g.add = function (r, o, s, a) {
            ...
            if (("number" != typeof o && (o = this._parseTimeOrLabel(o, 0, !0, r)), !(r instanceof t))) {
              ...
              if ("function" != typeof r)
                throw (
                  "Cannot add " + r + " into the timeline; it is not a tween, timeline, function, or string."
                );
              r = i.delayedCall(0, r);
            }
            if (
          ...
          (g._parseTimeOrLabel = function (e, i, n, r) {
            ...
            if ("string" == typeof i)
              return this._parseTimeOrLabel(
                i,
                n && "number" == typeof e && null == this._labels[i] ? e - this.duration() : 0,
                n
              );
            ...
            for (var o = [], s = this._first, a = 0; s; )
              s._startTime < r ||
                (s instanceof i
                  ? e !== !1 && (o[a++] = s)
                  : (n !== !1 && (o[a++] = s),
                    t !== !1 && ((o = o.concat(s.getChildren(!0, e, n))), (a = o.length)))),
                (s = s._next);
            return o;
          }),
          ...
          (u.render = function (t, e, i) {
            ...
            if (t >= p - 1e-7)
              ...
              if (
                ...
                (this._time = 0),
                (0 !== g || (0 === m && b !== r && (b > 0 || (0 > t && b >= 0)) && !this._locked)) &&
            ...
            (d = t[w]),
              ...
              a
                ? ((_ = e[h]),
                  ...
                  (g = c - (p + (((m - p) * ((3 * _) / (_ + b) + 0.5)) / 4 || 0))))
                : ((p = c - (c - u) * r * 0.5), (m = c + (f - c) * r * 0.5), (g = c - (p + m) / 2)),
              (p += g),
              (m += g),
              (d.c = v = p),
              ...
              (d.ca = v - u),
              (d.ba = E - u),
              o ? ((y = l(u, E, v, c)), t.splice(w, 1, y[0], y[1], y[2], y[3]), (w += 4)) : w++,
              (E = m);
          (d = t[w]),
            (d.b = E),
            (d.c = E + 0.4 * (d.d - E)),
            ...
            (d.ca = d.c - d.a),
            (d.ba = E - d.a),
            o && ((y = l(d.a, E, d.c, d.d)), t.splice(w, 1, y[0], y[1], y[2], y[3]));
        },
        u = function (t, n, r, o) {
          var a,
            l,
          ...
          for (h = y.length; --h > -1; ) {
            ...
            for (c = d - g + 1, d = 0, u = 0; c > u; u += g)
              (n = l[u]),
                ...
                (o = l[u + 2]),
                (a = 2 === g ? 0 : l[u + 3]),
                (l[d++] = p = 3 === g ? new s(n, r, o, a) : new s(n, (2 * r + n) / 3, (2 * r + o) / 3, o));
            l.length = d;
          }
          return m;
        },
        ...
        p = function (t, e) {
          ...
          for (r = s.length, n = 0; r > n; n++)
            (l += Math.sqrt(s[n])),
              (o = n % e),
              (f[o] = l),
              o === u && ((h += l), (o = (n / e) >> 0), (c[o] = f), (a[o] = h), (l = 0), (f = []));
            ...
            if (
              ((this._beziers =
                "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type
                  ? c(l, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, a)
                  : f(l, e.type, h)),
              ...
              for (
                ...
                (n = d[o][2]),
                  (this._initialRotations[o] =
                    (this._func[n] ? this._func[n].call(this._target) : this._target[n]) || 0),
                  this._overwriteProps.push(n);
              }
              ...
              for (r = w.length; --r > -1; )
                (o = w[r][2]),
                  ...
                  s &&
                    ...
                    (y += (b - y) * a),
                    (b += (g.c + (g.d - g.c) * a - b) * a),
                    (l = m ? Math.atan2(b - y, _ - v) * x + T : this._initialRotations[r]),
                    this._mod[o] && (l = this._mod[o](l, p)),
                    d[o] ? p[o](l) : (p[o] = l));
            }
          },
        ...
        var u,
          ...
          U = (function () {
            ...
            return (
              ...
              (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(V) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(V)) &&
          ...
          Z = (s.getStyle = function (t, e, i, n, r) {
            ...
            return U || "opacity" !== e
              ? (!n && t.style[e]
                  ...
                  : (i = i || K(t))
                  ? (o =
                      i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(A, "-$1").toLowerCase()))
          ...
          J = (q.convertToPixels = function (t, i, n, r, o) {
            ...
            if ((d && (n = -n), p && (n *= 100), "%" === r && -1 !== i.indexOf("border")))
              ...
              if (
                ((f.cssText = "border:0 solid red;position:" + Z(t, "position") + ";line-height:0;"),
              ...
              c.appendChild(H),
                ...
                u &&
                  "%" === r &&
                  s.cacheWidths !== !1 &&
                  ((l = c._gsCache = c._gsCache || {}), (l.time = h), (l.width = (a / n) * 100)),
                0 !== a || o || (a = J(t, i, n, r, !0));
            }
          ...
          et = function (t, e) {
            ...
            if ((e = e || K(t, null)))
              ...
              else for (i in e) (-1 === i.indexOf("Transform") || At === i) && (o[i] = e[i]);
            ...
            return (
              ...
              null == t
                ...
                : ((r = 360),
                  ...
                  o.length &&
                    (n && (n[i] = e + s),
                    -1 !== t.indexOf("short") && ((s %= r), s !== s % (r / 2) && (s = 0 > s ? s + r : s - r)),
                    -1 !== t.indexOf("_cw") && 0 > s
              ...
              e &&
                ...
                h === u
                  ...
                  : ((c = h - u),
                    ...
                    (s =
                      h === n ? (r - o) / c + (o > r ? 6 : 0) : h === r ? (o - n) / c + 2 : (n - r) / c + 4),
                    (s *= 60)),
                (i[0] = (s + 0.5) | 0),
                (i[1] = (100 * a + 0.5) | 0),
                (i[2] = (100 * l + 0.5) | 0)),
          ...
          dt = function (t, e) {
            ...
            for (i = 0; i < o.length; i++)
              (n = o[i]),
                ...
                (a +=
                  r +
                  (e ? "hsla(" + n[0] + "," + n[1] + "%," + n[2] + "%," + n[3] : "rgba(" + n.join(",")) +
                  ")");
            return a + t.substr(s);
          },
        ...
        var mt = function (t, e, i, n) {
            ...
            ((q._setPluginRatio = function (t) {
              ...
              for (var e, i, n, r, o, s = this.data, a = s.proxy, l = s.firstMPT, h = 1e-6; l; )
                (e = a[l.v]),
                  ...
                  (l = l._next);
              if (
                (s.autoRotate && (s.autoRotate.rotation = s.mod ? s.mod(a.rotation, this.t) : a.rotation),
                1 === t || 0 === t)
              )
            ...
            ((q._parseToProxy = function (t, e, i, n, r, o) {
              ...
              for (
                i._transform = null,
                  ...
                  n = u = i.parse(t, e, n, r),
                  j = m,
                  o && ((i._transform = p), c && ((c._prev = null), c._prev && (c._prev._next = null)));
                n && n !== c;
          ...
          bt = (s.parseComplex = function (t, e, i, n, r, o, a, l, h, c) {
            (i = i || o || ""),
              ...
              (n += ""),
              r && pt.test(n + i) && ((n = [i, n]), s.colorStringFilter(n), (i = n[0]), (n = n[1]));
            var f,
              d,
              p,
              m,
                ...
                (A = b.indexOf(")") + 1),
                  ...
                  E && !U && 0 === b[3]
                    ...
                    : (U || (E = !1),
                      I
                        ? a
                            .appendXtra(E ? "hsla(" : "hsl(", m[0], at(b[0], m[0]), ",", !1, !0)
                            .appendXtra("", m[1], at(b[1], m[1]), "%,", !1)
                            .appendXtra("", m[2], at(b[2], m[2]), E ? "%," : "%" + A, !1)
                        : a
                            .appendXtra(E ? "rgba(" : "rgb(", m[0], b[0] - m[0], ",", !0, !0)
                ...
                ? (s.l++,
                  ...
                  a > 0
                    ? ((s.data["xn" + a] = e + i),
                      ...
                      (s["xn" + a] = e),
                      s.plugin ||
                        ((s.xfirst = new yt(s, "xn" + a, e, i, s.xfirst || s, 0, s.n, r, s.pr)),
                        (s.xfirst.xs0 = 0)),
                      s)
        ...
        (h = xt.prototype),
          (h.parseComplex = function (t, e, i, n, r, o) {
            ...
            if (
              (this.multi &&
                (N.test(i) || N.test(e)
                  ? ((a = e.replace(N, "|").split("|")), (l = i.replace(N, "|").split("|")))
                  : f && ((a = [e]), (l = [i]))),
              l)
            ) {
              for (h = l.length > a.length ? l.length : a.length, s = 0; h > s; s++)
                (e = a[s] = a[s] || this.dflt),
                  ...
                  f &&
                    ((u = e.indexOf(f)),
                    (c = i.indexOf(f)),
                    u !== c && (-1 === c ? (a[s] = a[s].split(f).join("")) : -1 === u && (a[s] += " " + f)));
              (e = a.join(", ")), (i = l.join(", "));
            }
        ...
        var Ct,
          ...
          Mt = function (t, e, i, n, r, o) {
            ...
            T && ((_ = T.xOrigin), (b = T.yOrigin)),
              ...
              n &&
                ...
                (c = i.yOrigin = a[1] = h)),
              T &&
                (o && ((i.xOffset = T.xOffset), (i.yOffset = T.yOffset), (T = i)),
          ...
          Wt = function (t, e) {
            ...
            if (
              ...
              (l.svg || (t.getBBox && jt(t))) &&
                (i && -1 !== (u[At] + "").indexOf("matrix") && ((n = u[At]), (i = 0)),
            ...
            for (r = (n || "").match(y) || [], Tt = r.length; --Tt > -1; )
              (o = Number(r[Tt])),
                (r[Tt] = (s = o - (o |= 0)) ? ((s * h + (0 > s ? -0.5 : 0.5)) | 0) / h + o : o);
          ...
          Ht = (q.getTransform = function (t, i, n, r) {
            ...
            if (
              ...
              f.svg &&
                (Mt(t, Z(t, Dt, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")),
              ...
              if (16 === o.length) {
                ...
                f.zOrigin &&
                  ...
                  f.rotationX || f.rotationY
                    ? (f.skewX = 0)
                    : ((f.skewX = A || I ? Math.atan2(A, I) * z + f.rotation : f.skewX || 0),
                      Math.abs(f.skewX) > 90 &&
                ...
                (f.x = o[4] || 0),
                  ...
                  Math.abs(c) > 90 &&
                    Math.abs(c) < 270 &&
                    (d
                      ? ((l *= -1), (c += 0 >= u ? 180 : -180), (u += 0 >= u ? 180 : -180))
                      : ((h *= -1), (c += 0 >= c ? 180 : -180))),
                  (f.scaleX = l),
                  (f.scaleY = h),
                  (f.rotation = u),
                  (f.skewX = c),
                  Pt && ((f.rotationX = f.rotationY = f.z = 0), (f.perspective = v), (f.scaleZ = 1)),
                  f.svg &&
            ...
            if (f) {
              ...
              if (
                ...
                y
                  ? ((d = g / 2),
                    (p = v / 2),
                    (_ += ", Dx=" + (d - (d * a + p * l) + b) + ", Dy=" + (p - (d * h + p * u) + T) + ")"))
                  ...
                  (C = rt[Tt]),
                    ...
                    (S =
                      i !== n[C]
                        ...
                        ? d - n.ieOffsetX
                        : p - n.ieOffsetY),
                    (c[C] = (n[C] = Math.round(i - S * (0 === Tt || 2 === Tt ? 1 : A))) + "px");
              }
            }
          },
          qt =
              ...
              function (t) {
                  ...
                  return void (A || C.skewX || z
                    ? ((A *= M),
                      ...
                      w &&
                        ...
                        (o *= y),
                        C.skewY &&
                          ((y = Math.tan(C.skewY * M)), (y = Math.sqrt(1 + y * y)), (e *= y), (r *= y))),
                      z &&
                        ((L += C.xOrigin - (C.xOrigin * e + C.yOrigin * i) + C.xOffset),
                        (N += C.yOrigin - (C.xOrigin * r + C.yOrigin * o) + C.yOffset),
                        Ct &&
                      ...
                      z && Ct
                        ...
                        : (S[At] =
                            (C.xPercent || C.yPercent
                              ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix("
                              : "matrix(") + b))
                    : (S[At] =
                        (C.xPercent || C.yPercent
                          ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix("
                ...
                if (
                  ...
                  if (!(D || I || 1 !== O || j || z))
                    return void (S[At] =
                      (C.xPercent || C.yPercent
                        ? "translate(" + C.xPercent + "%," + C.yPercent + "%) translate3d("
                        : "translate3d(") +
                      L +
                      "px," +
                      N +
                ...
                (h = 1),
                  ...
                  (b =
                    C.xPercent || C.yPercent
                      ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix3d("
                      : "matrix3d("),
                  (b +=
                    (m > e && e > -m ? x : e) +
                    T +
              ...
              parser: function (t, e, i, n, o, a, l) {
                ...
                if (((n._transform = I), D && "string" == typeof D && At))
                  (c = H.style),
                    ...
                    I.svg &&
                      ...
                      (C.transformOrigin || C.svgOrigin) &&
                        ((D = {}),
                        Mt(t, st(C.transformOrigin), D, C.svgOrigin, C.smoothOrigin, !0),
                        (m = D.xOrigin),
                        (y = D.yOrigin),
                    ...
                    null != C.xPercent && (u.xPercent = lt(C.xPercent, I.xPercent)),
                    null != C.yPercent && (u.yPercent = lt(C.yPercent, I.yPercent));
                  ...
                  "string" == typeof C.x &&
                    ...
                    (u.skewY = ht(C.skewY, I.skewY)) && ((u.skewX += u.skewY), (u.rotation += u.skewY));
                }
                for (
                  Pt && null != C.force3D && ((I.force3D = C.force3D), (d = !0)),
                ...
                return (
                  ...
                  I.svg &&
                    ...
                    (o = _t(I, "xOrigin", (T ? I : u).xOrigin, u.xOrigin, o, A)),
                    (o = _t(I, "yOrigin", (T ? I : u).yOrigin, u.yOrigin, o, A)),
                    (m !== I.xOffset || y !== I.yOffset) &&
                      ((o = _t(I, "xOffset", T ? m : I.xOffset, I.xOffset, o, A)),
                      (o = _t(I, "yOffset", T ? y : I.yOffset, I.yOffset, o, A))),
                    (D = Ct ? null : "0px 0px")),
                  (D || (Pt && f && I.zOrigin)) &&
                    (At
                      ? ((d = !0),
                        ...
                        Pt
                          ? ((c = I.zOrigin),
                            (D = D.split(" ")),
                            (I.zOrigin =
                              (D.length > 2 && (0 === c || "0px" !== D[2]) ? parseFloat(D[2]) : c) || 0),
                          ...
                          : (o.xs0 = o.e = D))
                      : st(D + "", I)),
                  d && (n._transformType = (I.svg && Ct) || (!f && 3 !== this._transformType) ? 2 : 3),
                  h && (l[i] = h),
                  o
                );
              },
                ...
                this.p.indexOf("border") && (E[h] = Q(E[h])),
                  ...
                  y !== _ &&
                    ...
                    "%" === y
                      ? ((f = (T / g) * 100 + "%"), (c = (x / v) * 100 + "%"))
                      : "em" === y
                      ? ((w = J(t, "borderLeft", 1, "em")), (f = T / w + "em"), (c = x / w + "em"))
                      : ((f = T + "px"), (c = x + "px")),
          ...
          wt("backgroundPosition", {
            ...
            parser: function (t, e, i, n, o, s) {
              ...
              if (
                ...
                v.split(",").length < 2 &&
                ((f = Z(t, "backgroundImage").replace(D, "")), f && "none" !== f)
              ) {
                for (a = g.split(" "), l = v.split(" "), B.setAttribute("src", f), h = 2; --h > -1; )
                  (g = a[h]),
                    (u = -1 !== g.indexOf("%")),
                    u !== (-1 !== l[h].indexOf("%")) &&
                      ((c = 0 === h ? t.offsetWidth - B.width : t.offsetHeight - B.height),
                      (a[h] = u ? (parseFloat(g) / 100) * c + "px" : (parseFloat(g) / c) * 100 + "%"));
                g = a.join(" ");
              }
          ...
          if (
            ...
            if ("all" === this.e) (s.cssText = ""), (r = !0);
              ...
              for (e = this.e.split(" ").join("").split(","), n = e.length; --n > -1; )
                (i = e[n]),
                  l[i] && (l[i].parse === a ? (r = !0) : (i = "transformOrigin" === i ? Dt : l[i].p)),
                  Ut(s, i);
            r &&
              (Ut(s, At),
        ...
        (h = s.prototype),
          ...
          (h._onInitTween = function (t, e, a, h) {
            ...
            if (
              (c &&
                "" === S.zIndex &&
                ((d = Z(t, "zIndex", r)), ("auto" === d || "" === d) && this._addLazySet(S, "zIndex", 0)),
              "string" == typeof e &&
                ((_ = S.cssText),
                (d = et(t, r)),
                (S.cssText = _ + ";" + e),
                ...
                C = 3 === this._transformType,
                  At
                    ? f &&
                      ...
                      "" === S.zIndex &&
                        ((x = Z(t, "zIndex", r)),
                        ("auto" === x || "" === x) && this._addLazySet(S, "zIndex", 0)),
                      p &&
                        this._addLazySet(
                          S,
              ...
              (d = e[s]),
                ...
                a
                  ...
                  : ((f = Z(t, s, r) + ""),
                    ...
                    -1 !== s.indexOf("Color") ||
                    (y && S.test(d))
                      ? (y || ((d = ft(d)), (d = (d.length > 3 ? "rgba(" : "rgb(") + d.join(",") + ")")),
                      ...
                      : ((h = parseFloat(f)),
                        ...
                        _
                          ? ((c = parseInt(d.charAt(0) + "1", 10)),
                            ...
                            (c *= parseFloat(d)),
                            (m = d.replace(x, "")))
                          : ((c = parseFloat(d)), (m = y ? d.replace(x, "") : "")),
                        "" === m && (m = s in n ? n[s] : p),
                        ...
                        p !== m &&
                          ...
                          ((h = J(t, s, h, p)),
                          "%" === m
                            ? ((h /= J(t, s, 100, "%") / 100), e.strictUnits !== !0 && (f = h + "%"))
                        ...
                        (!h && 0 !== h) || (!c && 0 !== c)
                          ? void 0 !== b[s] && (d || (d + "" != "NaN" && null != d))
                            ? ((i = new yt(b, s, c || h || 0, 0, i, -1, s, !1, 0, f, d)),
                              (i.xs0 =
                                "none" !== d || ("display" !== s && -1 === s.indexOf("Style")) ? d : f))
                  ...
                  if (((e = r.c * t + r.s), r.r ? (e = Math.round(e)) : o > e && e > -o && (e = 0), r.type))
                    if (1 === r.type)
                      if (((n = r.l), 2 === n)) r.t[r.p] = r.xs0 + e + r.xs1 + r.xn1 + r.xs2;
                        ...
                        r.t[r.p] =
                          r.xs0 + e + r.xs1 + r.xn1 + r.xs2 + r.xn2 + r.xs3 + r.xn3 + r.xs4 + r.xn4 + r.xs5;
                      else {
      ...
      (i._onInitAllProps = function () {
        for (
          var t,
            ...
            n,
            r = this._tween,
            o = r.vars.roundProps.join ? r.vars.roundProps : r.vars.roundProps.split(","),
            s = o.length,
            a = {},
          ...
          "useRadians" !== r &&
            ...
            (s = parseFloat(
              "function" != typeof t[r]
                ? t[r]
                : t[
                    r.indexOf("set") || "function" != typeof t["get" + r.substr(3)] ? r : "get" + r.substr(3)
                  ]()
            )),
            (a = this.finals[r] =
            ...
            h.length &&
              ((o = h.join("_")),
              -1 !== o.indexOf("short") && ((l %= u), l !== l % (u / 2) && (l = 0 > l ? l + u : l - u)),
              -1 !== o.indexOf("_cw") && 0 > l
                ? (l = ((l + 9999999999 * u) % u) - ((l / u) | 0) * u)
                : -1 !== o.indexOf("ccw") && l > 0 && (l = ((l - 9999999999 * u) % u) - ((l / u) | 0) * u)),
            (l > c || -c > l) && (this._addTween(t, r, s, s + l, r), this._overwriteProps.push(r)));
        return !0;
      },
      set: function (t) {
        var e;
    ...
    if (!n.TweenLite) {
            ...
            if (0 === _ && s) {
              if (
                ...
                if (
                  ...
                  define(
                    (t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + r.split(".").pop(),
                    [],
                    function () {
                      return p;
                    }
      ...
      var _ = [0, 0, 1, 1],
        ...
        x = (b.register = function (t, e, i, n) {
          for (
            var r, o, s, a, l = e.split(","), h = l.length, c = (i || "easeIn,easeOut,easeInOut").split(",");
            --h > -1;
      ...
      for (
        ...
        (s = r[o] + ",Power" + o),
          ...
          x(new b(null, null, 2, o), s, "easeIn" + (0 === o ? ",easeNone" : "")),
      ...
      (s = w.prototype),
        (s.addEventListener = function (t, e, i, n, r) {
          ...
          var o,
            ...
            u = 0;
          for (
            this !== a || l || a.wake(), null == h && (this._listeners[t] = h = []), s = h.length;
            --s > -1;
        ...
        var i,
          ...
          v = function (t) {
            ...
            l > p && (u += l - m),
              ...
              (h.time = (A - u) / 1e3),
              (e = h.time - s),
              (!i || e > 0 || t === !0) && (h.frame++, (s += e + (e >= o ? 0.004 : o - e)), (a = !0)),
              t !== !0 && (r = n(v)),
              a && h.dispatchEvent(g);
          };
        w.call(h),
          ...
          (h.wake = function (t) {
            null !== r ? h.sleep() : t ? (u += -A + (A = S())) : h.frame > 10 && (A = S() - p + 5),
              (n =
                0 === i
                  ? d
                  : f && E
        ...
        (s.eventCallback = function (t, e, i, n) {
          if ("on" === (t || "").substr(0, 2)) {
            ...
            null == e
              ...
              : ((r[t] = e),
                (r[t + "Params"] =
                  p(i) && -1 !== i.join("").indexOf("{self}") ? this._swapSelfInParams(i) : i),
                (r[t + "Scope"] = n)),
      ...
      var k = y(
          ...
          function (e, i, n) {
            ...
            if (
              ((this._overwrite = l =
                null == l ? U[k.defaultOverwrite] : "number" == typeof l ? l >> 0 : U[l]),
              (a || e instanceof Array || (e.push && p(e))) && "number" != typeof e[0])
            )
              for (
                this._targets = s = f(e), this._propLookup = [], this._siblings = [], r = 0;
                r < s.length;
                r++
              )
                (o = s[r]),
                    ...
                    ? "string" != typeof o
                      ? o.length &&
                        ...
                        : ((this._siblings[r] = Q(o, this, !1)),
                          1 === l && this._siblings[r].length > 1 && Z(o, this, null, 1, this._siblings[r]))
                      : ((o = s[r--] = k.selector(o)), "string" == typeof o && s.splice(r + 1, 1))
                    : s.splice(r--, 1);
            else
              (this._propLookup = {}),
          ...
          return (
            "number" !== f &&
              ...
              "string" == typeof c && (s || isNaN(c))
                ...
                : d || ((p.s = parseFloat(c)), (p.c = parseFloat(n) - p.s || 0))),
        ...
        (I._updateRoot = k.render =
          function () {
            ...
            if (
              ...
              if (
                ((i = Y._first),
                (!i || i._paused) && k.autoSleep && !$._first && 1 === a._listeners.tick.length)
              ) {
      ...
      var Q = function (t, e, i) {
          var n,
            ...
            o = t._gsTweenID;
          if (
            (B[o || (t._gsTweenID = o = "t" + q++)] || (B[o] = { target: t, tweens: [] }),
        ...
        K = function (t, e, i, n) {
          ...
          return (
            s && (r = s(t, e, i, n)), (s = k.onOverwrite), s && (o = s(t, e, i, n)), r !== !1 && o !== !1
          );
        },
            ...
            (a = r[o]) === e ||
              ...
              (a._timeline !== e._timeline
                ...
                : a._startTime <= u &&
                  ...
                  (((p || !a._initted) && u - a._startTime <= 2e-10) || (f[d++] = a)));
          for (o = d; --o > -1; )
            if (
              ((a = f[o]), 2 === n && a._kill(i, t, e) && (s = !0), 2 !== n || (!a._firstPT && a._initted))
            ) {
      ...
      (s._init = function () {
        ...
        (s._initProps = function (e, i, n, r, o) {
          ...
          R[e._gsTweenID] && G(),
            this.vars.css ||
              (e.style && e !== t && e.nodeType && H.css && this.vars.autoCSS !== !1 && L(this.vars, e));
          for (s in this.vars)
          ...
          if (t >= l - 1e-7)
            (this._totalTime = this._time = l),
              ...
              0 === l &&
                (this._initted || !this.vars.lazy || i) &&
                (this._startTime === this._timeline._duration && (t = 0),
                (0 > h || (0 >= t && t >= -1e-7) || (h === c && "isPause" !== this.data)) &&
                  h !== t &&
...
if (
      ...
      a = _gsScope._gsDefine.plugin({
        ...
        init: function (t, i, n) {
          return (
            ...
            "object" != typeof i
              ? ((i = { y: i }),
                "string" == typeof i.y && "max" !== i.y && "=" !== i.y.charAt(1) && (i.x = i.y))
            ...
            null != i.x
              ? (this._addTween(this, "x", this.x, s(i.x, t, "x") - (i.offsetX || 0), "scrollTo_x", !0),
                this._overwriteProps.push("scrollTo_x"))
              : (this.skipX = !0),
            null != i.y
              ? (this._addTween(this, "y", this.y, s(i.y, t, "y") - (i.offsetY || 0), "scrollTo_y", !0),
        ...
        set: function (t) {
          ...
          this.x < 0 && (this.x = 0),
            this.y < 0 && (this.y = 0),
            this._autoKill &&
              (!this.skipX && (s > l || -l > s) && n < i(this._target, "x") && (this.skipX = !0),
  ...
  !(function (t, e) {
    ...
    function o(t) {
      ...
      for (var r = t; (r = r.parentNode) && r && 1 === r.nodeType; ) {
        ...
        /(auto|scroll)/.test(a + h + l) &&
          ("absolute" !== i || ["relative", "absolute", "fixed"].indexOf(o.position) >= 0) &&
          n.push(r);
      }
      return (
        n.push(t.ownerDocument.body), t.ownerDocument !== document && n.push(t.ownerDocument.defaultView), n
      );
    }
    function s() {
    ...
    function b() {
      for (var t = { top: 0, left: 0 }, e = arguments.length, i = Array(e), n = 0; e > n; n++)
        i[n] = arguments[n];
      return (
        ...
        n = function n() {
          return "undefined" != typeof e && e > 16
            ...
            : void (
                ...
                (null != i && (clearTimeout(i), (i = null)), (t = _()), F(), (e = _() - t))
              );
        };
            ...
            },
            {
              ...
              value: function () {
                ...
                if ("scroll-handle" === this.targetModifier) {
                  ...
                  return (
                    (e.top = h * (s - e.height - l) + t.top + parseFloat(n.borderTopWidth)),
                    this.target === document.body && (e.height = Math.max(e.height, 24)),
                    e
                  );
                }
                ...
                n.forEach(function (t) {
                  ...
                  k(function () {
                    "undefined" != typeof i._addAttachClasses &&
                      ...
                      i.options.addTargetClasses !== !1 && g(i.target, i._addAttachClasses, o),
            ...
            },
            {
              ...
              value: function () {
                ...
                if (this.enabled) {
                  ...
                  (f = b(f, p)), (d = b(d, m));
                  for (
                    var g = u.left + d.left - f.left, v = u.top + d.top - f.top, y = 0;
                    y < E.modules.length;
                    ++y
                  ) {
                    var _ = E.modules[y],
                  ...
                  return (
                    S.innerHeight > C.documentElement.clientHeight &&
                      ((A = this.cache("scrollbar-size", h)), (w.viewport.bottom -= A.height)),
                    S.innerWidth > C.documentElement.clientWidth &&
                      ((A = this.cache("scrollbar-size", h)), (w.viewport.right -= A.width)),
                    (-1 === ["", "static"].indexOf(C.body.style.position) ||
                      -1 === ["", "static"].indexOf(C.body.parentElement.style.position)) &&
                    ...
                    "undefined" != typeof this.options.optimizations &&
                      ...
                      !(function () {
                        ...
                        if (
                          ...
                          (i.right = C.body.scrollWidth - i.left - r.width + o.right),
                          (i.bottom = C.body.scrollHeight - i.top - r.height + o.bottom),
                ...
                if ("undefined" != typeof this.element.parentNode) {
                  ...
                  var h = { top: "", left: "", right: "", bottom: "" },
                    c = function (t, i) {
                      ...
                      if (r !== !1) {
                        ...
                        (h[z] = "translateX(" + s + "px) translateY(" + o + "px)"),
                  ...
                  if (
                    ((i.page.top || i.page.bottom) && (i.page.left || i.page.right)
                      ...
                      : "undefined" != typeof i.offset && i.offset.top && i.offset.left
                      ? !(function () {
                          h.position = "absolute";
        ...
        return (
          this.options.constraints.forEach(function (t) {
            ...
            ("target" === c || "both" === c) &&
              ...
              i + s > _[3] && "bottom" === v.top && ((i -= f), (v.top = "top"))),
              "together" === c &&
                ("top" === v.top &&
                  ("bottom" === y.top && i < _[1]
              ...
              ("target" === u || "both" === u) &&
                (n < _[0] && "left" === v.left && ((n += d), (v.left = "right")),
                n + l > _[2] && "right" === v.left && ((n -= d), (v.left = "left"))),
              "together" === u &&
                (n < _[0] && "left" === v.left
                  ? "right" === y.left
                  ...
                  : "center" === v.left &&
                    (n + l > _[2] && "left" === y.left
                      ? ((n -= l), (y.left = "right"))
                      : n < _[0] && "right" === y.left && ((n += l), (y.left = "left")))),
              ("element" === c || "both" === c) &&
                (i < _[1] && "bottom" === y.top && ((i += s), (y.top = "top")),
                i + s > _[3] && "top" === y.top && ((i -= s), (y.top = "bottom"))),
              ("element" === u || "both" === u) &&
                (n < _[0] &&
                  ("right" === y.left
                    ? ((n += l), (y.left = "left"))
                ...
                n + l > _[2] &&
                  ("left" === y.left
                    ? ((n -= l), (y.left = "right"))
                    : "center" === y.left && ((n -= l / 2), (y.left = "right")))),
              "string" == typeof h
            ...
            i < _[1] && (h.indexOf("top") >= 0 ? ((i = _[1]), b.push("top")) : T.push("top")),
              i + s > _[3] &&
                (h.indexOf("bottom") >= 0 ? ((i = _[3] - s), b.push("bottom")) : T.push("bottom")),
    ...
    var n =
      ...
      s =
        ((function (t) {
          ...
          return (
            t(document).on(f.CLICK_DATA_API, c.DISMISS, p._handleDismiss(new p())),
              ...
              return (
                ...
                (h.prototype._slide = function (e, i) {
                  ...
                  if (!h.isDefaultPrevented() && r && s) {
                    ...
                    o.supportsTransitionEnd() && t(this._element).hasClass(y.SLIDE)
                      ? (t(s).addClass(e),
                        o.reflow(s),
                        t(r).addClass(l),
                        t(s).addClass(l),
                        t(r)
                          .one(o.TRANSITION_END, function () {
                            t(s).removeClass(l).removeClass(e),
                              ...
                              t(r).removeClass(y.ACTIVE).removeClass(e).removeClass(l),
                              (n._isSliding = !1),
                              setTimeout(function () {
              ...
              return (
                ...
                (l.prototype.show = function () {
                  ...
                  if (!this._isTransitioning && !t(this._element).hasClass(m.ACTIVE)) {
                    ...
                    if (
                      (this._parent &&
                        ((i = t.makeArray(t(this._parent).find(v.ACTIVES))), i.length || (i = null)),
                      ...
                      if ((t(this._element).trigger(r), !r.isDefaultPrevented())) {
                        ...
                        t(this._element).removeClass(m.COLLAPSE).addClass(m.COLLAPSING),
                          ...
                          this._triggerArray.length &&
                            t(this._triggerArray).removeClass(m.COLLAPSED).attr("aria-expanded", !0),
                          this.setTransitioning(!0);
                        var h = function () {
                          t(e._element).removeClass(m.COLLAPSING).addClass(m.COLLAPSE).addClass(m.ACTIVE),
                            (e._element.style[s] = ""),
                  ...
                  if (!this._isTransitioning && t(this._element).hasClass(m.ACTIVE)) {
                    ...
                    if ((t(this._element).trigger(i), !i.isDefaultPrevented())) {
                      ...
                      (this._element.style[n] = this._element[r] + "px"),
                        ...
                        t(this._element).addClass(m.COLLAPSING).removeClass(m.COLLAPSE).removeClass(m.ACTIVE),
                        this._element.setAttribute("aria-expanded", !1),
                        this._triggerArray.length &&
                          t(this._triggerArray).addClass(m.COLLAPSED).attr("aria-expanded", !1),
                        this.setTransitioning(!0);
                      var s = function () {
                        e.setTransitioning(!1),
                          t(e._element).removeClass(m.COLLAPSING).addClass(m.COLLAPSE).trigger(p.HIDDEN);
                      };
                      return (
                        (this._element.style[n] = ""),
                        o.supportsTransitionEnd()
                          ? void t(this._element).one(o.TRANSITION_END, s).emulateTransitionEnd(c)
                          : void s()
                      );
                    }
                  }
                ...
                (l.prototype._getConfig = function (i) {
                  return (
                    (i = t.extend({}, f, i)), (i.toggle = Boolean(i.toggle)), o.typeCheckConfig(e, i, d), i
                  );
                }),
                ...
                (l.prototype._addAriaAndCollapsedClass = function (e, i) {
                  if (e) {
                    ...
                    e.setAttribute("aria-expanded", n),
                      i.length && t(i).toggleClass(m.COLLAPSED, !n).attr("aria-expanded", n);
                  }
                }),
              ...
              return (
                      ...
                      if (
                        ...
                        t(s).trigger(l),
                          l.isDefaultPrevented() ||
                            ...
                            t(s).removeClass(m.ACTIVE).trigger(t.Event(p.HIDDEN, a)));
                      }
                    }
                  }
                }),
                ...
                (e._dataApiKeydownHandler = function (i) {
                  if (
                    ...
                    !/input|textarea/i.test(i.target.tagName) &&
                    (i.preventDefault(), i.stopPropagation(), !this.disabled && !t(this).hasClass(m.DISABLED))
                  ) {
              ...
              return (
                ...
                (h.prototype.show = function (e) {
                  ...
                  t(this._element).trigger(n),
                    this._isShown ||
                      ...
                      t(this._element).on(g.CLICK_DISMISS, y.DATA_DISMISS, function (t) {
                        return i.hide(t);
                      }),
                ...
                (h.prototype.hide = function (e) {
                  ...
                  t(this._element).trigger(n),
                    this._isShown &&
                      ...
                      o.supportsTransitionEnd() && t(this._element).hasClass(v.FADE)
                        ? t(this._element)
                            .one(o.TRANSITION_END, function (t) {
                ...
                (h.prototype._showBackdrop = function (e) {
                  ...
                  if (this._isShown && this._config.backdrop) {
                    ...
                    o.supportsTransitionEnd() && t(this._element).hasClass(v.FADE)
                      ? t(this._backdrop).one(o.TRANSITION_END, s).emulateTransitionEnd(f)
                      : s();
                  } else e && e();
                }),
              ...
              return (
                (h.prototype.refresh = function () {
                  ...
                  s.map(function (e) {
                    ...
                    return (
                      s && (i = t(s)[0]),
                      i && (i.offsetWidth || i.offsetHeight) ? [t(i)[n]().top + r, s] : null
                    );
                  })
                    .filter(function (t) {
                      return t;
                ...
                (h.prototype._activate = function (e) {
                  ...
                  n.hasClass(p.DROPDOWN_ITEM)
                    ? (n.closest(m.DROPDOWN).find(m.DROPDOWN_TOGGLE).addClass(p.ACTIVE), n.addClass(p.ACTIVE))
                    : n.parents(m.LI).find(m.NAV_LINKS).addClass(p.ACTIVE),
                    t(this._scrollElement).trigger(d.ACTIVATE, { relatedTarget: e });
                }),
              ...
              return (
                ...
                (e.prototype._activate = function (e, i, n) {
                  var r = this,
                    ...
                    a =
                      n &&
                      o.supportsTransitionEnd() &&
                      ((s && t(s).hasClass(f.FADE)) || Boolean(t(i).find(d.FADE_CHILD)[0])),
                    l = function () {
                      return r._transitionComplete(e, s, a, n);
                    };
                  s && a ? t(s).one(o.TRANSITION_END, l).emulateTransitionEnd(u) : l(),
                ...
                (e.prototype._transitionComplete = function (e, i, n, r) {
                  ...
                  if (
                    ...
                    n ? (o.reflow(e), t(e).addClass(f.IN)) : t(e).removeClass(f.FADE),
              ...
              return (
                ...
                (h.prototype.hide = function (e) {
                  var i = this,
                    ...
                    s = function () {
                      i._hoverState !== m.ACTIVE && n.parentNode && n.parentNode.removeChild(n),
                ...
                (h.prototype.setContent = function () {
                  ...
                  this.setElementContent(e.find(y.TOOLTIP_INNER), this.getTitle()),
                    e.removeClass(v.FADE).removeClass(v.ACTIVE),
                    this.cleanupTether();
                }),
                (h.prototype.setElementContent = function (e, i) {
                  var r = this.config.html;
                  "object" === ("undefined" == typeof i ? "undefined" : n(i)) && (i.nodeType || i.jquery)
                    ? r
                ...
                (h.prototype._enter = function (e, i) {
                  ...
                  return (
                    ...
                    t(i.getTipElement()).hasClass(v.ACTIVE) || i._hoverState === m.ACTIVE
                ...
                (h._jQueryInterface = function (e) {
                  return this.each(function () {
                    ...
                    if (
                      ...
                      (i || ((i = new h(this, r)), t(this).data(a, i)), "string" == typeof e)
                    ) {
                      if (void 0 === i[e]) throw new Error('No method named "' + e + '"');
                      i[e]();
                    }
            ...
            (c._jQueryInterface = function (t) {
              return this.each(function () {
                ...
                if (
                  ...
                  (e || ((e = new c(this, i)), o(this).data(h, e)), "string" == typeof t)
                ) {
          ...
          for (var e = ["webkit", "moz"], i = 0; i < e.length && !t.requestAnimationFrame; ++i) {
            ...
            (t.requestAnimationFrame = t[n + "RequestAnimationFrame"]),
              (t.cancelAnimationFrame =
                t[n + "CancelAnimationFrame"] || t[n + "CancelRequestAnimationFrame"]);
          }
          if (
      ...
      s = (function () {
        ...
        for (var r in n)
          "undefined" != typeof i.style[r] &&
            ((i.style[r] = "translate3d(1px,1px,1px)"), (e = t.getComputedStyle(i).getPropertyValue(n[r])));
        return (
      ...
      m = (function () {
        function t(t, i) {
          ...
          if (
            ...
            o && "object" == typeof o && "undefined" != typeof o.length && (o = o[0]),
      ...
      (m.prototype.init = function () {
        ...
        for (var r = e.$item; null !== r && r !== document && 0 === e.parentWithTransform; ) {
          ...
          o &&
            ...
            e.css(e.image.$container, { transform: "translateX(0) translateY(0)" })),
            (r = r.parentNode);
        }
      ...
      (m.prototype.coverImage = function () {
        ...
        if (t.image.width && t.image.height) {
          ...
          u &&
            ...
            h < 0 || h > 1 ? (d = Math.max(n, o) + 2 * Math.abs(c)) : (d += Math.abs(o - n) * (1 - h))),
            (f = (d * a) / l),
            f < i && ((f = i), (d = (f * l) / a)),
      ...
      (m.prototype.onScroll = function (t) {
        ...
        if (e.image.width && e.image.height) {
          var i = e.$item.getBoundingClientRect(),
            ...
            h = i;
          if (
            (e.options.elementInViewport && (h = e.options.elementInViewport.getBoundingClientRect()),
            (e.isElementInViewport = h.bottom >= 0 && h.right >= 0 && h.top <= o && h.left <= r),
            ...
            if (
              ...
              var _ = 1;
              e.options.speed < 0 ? (_ -= e.options.speed * y) : (_ += e.options.speed * (1 - y)),
  ...
  !(function (t) {
    ...
    var r = (function () {
      function t(t, n) {
        var r = this;
        (r.url = t),
          (r.options_default = { autoplay: 1, loop: 1, mute: 1, controls: 0, startTime: 0, endTime: 0 }),
    ...
    (r.prototype.play = function (t) {
      ...
      e.player &&
        ("youtube" === e.type &&
          e.player.playVideo &&
          ("undefined" != typeof t && e.player.seekTo(t || 0), e.player.playVideo()),
        "vimeo" !== e.type ||
          o ||
          ("undefined" != typeof t
            ? ((o = 1),
      ...
      (r.prototype.getIframe = function (e) {
        ...
        return i.$iframe
          ...
          : void i.onAPIready(function () {
              ...
              var o;
              if (
                (i.$iframe || ((o = document.createElement("div")), (o.style.display = "none")),
                "youtube" === i.type)
              ) {
                (i.playerOptions = {}),
                  (i.playerOptions.videoId = i.videoID),
                  (i.playerOptions.width = t.innerWidth || document.documentElement.clientWidth),
                ...
                i.playerOptions.events = {
                  ...
                  onStateChange: function (t) {
                    i.options.loop && t.data === YT.PlayerState.ENDED && i.play(i.options.startTime),
                      s || t.data !== YT.PlayerState.PLAYING || ((s = 1), i.fire("started", t)),
                ...
                (i.player = i.player || new t.YT.Player(i.playerID, i.playerOptions)),
                ...
                (i.playerOptions = ""),
                  ...
                  i.$iframe ||
                    ...
                    i.$iframe.setAttribute(
                      "src",
                      "https://player.vimeo.com/video/" + i.videoID + "?" + i.playerOptions
                    ),
    ...
    r.prototype.loadAPI = function () {
      ...
      if (!s || !a) {
        var i = "";
        if (
          ("youtube" !== e.type || s || ((s = 1), (i = "//www.youtube.com/iframe_api")),
          "vimeo" !== e.type || a || ((a = 1), (i = "//player.vimeo.com/api/player.js")),
          i)
        ) {
  ...
  (function () {
    ...
    if ("undefined" != typeof jarallax) {
      ...
      t.prototype.initImg = function () {
        var t = this;
        if (
          (t.options.videoSrc || (t.options.videoSrc = t.$item.getAttribute("data-jarallax-video") || !1),
          t.options.videoSrc)
        ) {
  ...
  (function (t, e) {
    ...
    return (
      ...
      (p._wrapSelect = function (t) {
        ...
        !this.isDragSelect && s < o ? (t += e) : !this.isDragSelect && a < o && (t -= e),
  ...
  (function (t, e) {
    ...
    n.extend(d, e.prototype),
      ...
      (d._itemize = function (t) {
        for (
          var e = this._filterFindItemElements(t), i = this.constructor.Item, n = [], r = 0;
          r < e.length;
          r++
        ) {
          var o = e[r],
      ...
      (d._getMeasurement = function (t, e) {
        var n,
          r = this.options[t];
        r
          ? ("string" == typeof r ? (n = this.element.querySelector(r)) : r instanceof HTMLElement && (n = r),
            (this[t] = n ? i(n)[e] : r))
          : (this[t] = 0);
      }),
  ...
  (function (t, e) {
    ...
    return (
      ...
      (i.prototype._manageStamp = function (t) {
        ...
        for (
          var h = this._getOption("originTop"), u = (h ? n.top : n.bottom) + i.outerHeight, c = a;
          l >= c;
          c++
        )
  ...
  !(function (t, e, i, n) {
    ...
    function D(t) {
      for (var e = [], i = 0; i < t.pointers.length; )
        (e[i] = { clientX: mt(t.pointers[i].clientX), clientY: mt(t.pointers[i].clientY) }), i++;
    ...
    t.MSPointerEvent &&
      !t.PointerEvent &&
      ((Gt = "MSPointerDown"), (Qt = "MSPointerMove MSPointerUp MSPointerCancel")),
      l(j, w, {
        handler: function (t) {
          var e = this.store,
            i = !1,
    ...
    l(F, w, {
      handler: function (t) {
        ...
        if ((e === Pt && (this.started = !0), this.started)) {
          ...
          e & (Ot | Lt) && i[0].length - i[1].length === 0 && (this.started = !1),
            this.callback(this.manager, e, {
              pointers: i[0],
              changedPointers: i[1],
              pointerType: Ct,
    ...
    Y.prototype = {
      set: function (t) {
        t == se && (t = this.compute()),
          oe && this.manager.element.style && fe[t] && (this.manager.element.style[re] = t),
    ...
    (Q.prototype = {
      ...
      l(et, tt, {
        ...
        directionTest: function (t) {
          ...
          return (
            r & e.direction ||
              (e.direction & Ft
                ? ((r = 0 === o ? Nt : 0 > o ? Rt : Mt), (i = o != this.pX), (n = Math.abs(t.deltaX)))
                : ((r = 0 === s ? Nt : 0 > s ? zt : jt), (i = s != this.pY), (n = Math.abs(t.deltaY)))),
            (t.direction = r),
        ...
        emit: function (t) {
          this.state === ve &&
            (t && t.eventType & Ot
              ...
              : ((this._input.timeStamp = vt()), this.manager.emit(this.options.event, this._input)));
        },
      }),
      l(rt, tt, {
      ...
      l(ot, tt, {
        defaults: { event: "swipe", threshold: 10, velocity: 0.3, direction: Ft | Wt, pointers: 1 },
        getTouchAction: function () {
    ...
    (lt.prototype = {
      ...
      add: function (t) {
        ...
        return (
          e && this.remove(e), this.recognizers.push(t), (t.manager = this), this.touchAction.update(), t
        );
      },
      remove: function (t) {
    ...
    (C = {
      ...
      (I = function () {
        ...
        return (
          ...
          !!(t = /(?=.+Mac OS X)(?=.+Firefox)/.test(i)) &&
            ((n = /Firefox\/\d{2}\./.exec(i)), n && (n = n[0].replace(/\D+/g, "")), t && +n > 23)
        );
      }),
      (g = (function () {
        function h(n, o) {
        ...
        return (
          (h.prototype.preventScrolling = function (t, e) {
            if (this.isActive)
              if (t.type === o)
                ((e === s && t.originalEvent.detail > 0) || (e === x && t.originalEvent.detail < 0)) &&
                  t.preventDefault();
              else if (t.type === m) {
          ...
          (h.prototype.setOnScrollStyles = function () {
            var t;
            A ? ((t = {}), (t[P] = "translate(0, " + this.sliderTop + "px)")) : (t = { top: this.sliderTop }),
              D
            ...
            this.events = {
              ...
              drag: (function (t) {
                return function (e) {
                  return (
                    (t.sliderY =
                      e.pageY - t.$el.offset().top - t.paneTop - (t.offsetY || 0.5 * t.sliderHeight)),
                    t.scroll(),
                    t.contentScrollTop >= t.maxScrollTop && t.prevScrollTop !== t.maxScrollTop
                      ? t.$el.trigger("scrollend")
                      : 0 === t.contentScrollTop && 0 !== t.prevScrollTop && t.$el.trigger("scrolltop"),
                    !1
                  );
                };
              })(this),
              ...
              panedown: (function (t) {
                return function (e) {
                  return (
                    (t.sliderY = (e.offsetY || e.originalEvent.layerY) - 0.5 * t.sliderHeight),
                    t.scroll(),
                    t.events.down(e),
                    !1
                  );
                    ...
                    t.isBeingDragged ||
                      ...
                      null != e &&
                        (t.contentScrollTop >= t.maxScrollTop
                          ? (t.options.preventPageScrolling && t.preventScrolling(e, s),
                            t.prevScrollTop !== t.maxScrollTop && t.$el.trigger("scrollend"))
                          : 0 === t.contentScrollTop &&
                            (t.options.preventPageScrolling && t.preventScrolling(e, x),
          ...
          (h.prototype.addEvents = function () {
            ...
            this.removeEvents(),
              ...
              this.iOSNativeScrolling ||
                (this.slider.bind(c, t[s]), this.pane.bind(c, t[v]).bind("" + m + " " + o, t[w])),
          ...
          (h.prototype.generate = function () {
            ...
            return (
              ...
              (s = this.$el.children("." + a)).length ||
                s.children("." + l).length ||
                this.$el.append('<div class="' + a + '"><div class="' + l + '" /></div>'),
              ...
              0 === r && I()
                ...
                : r && ((i = { right: -r }), this.$el.addClass("has-scrollbar")),
          ...
          (h.prototype.reset = function () {
            ...
            return this.iOSNativeScrolling
              ...
              : (this.$el.find("." + this.options.paneClass).length || this.generate().stop(),
                ...
                c > 0 && (this.$el.height(""), this.$el.height(t.scrollHeight > c ? c : t.scrollHeight)),
                ...
                this.pane.show(),
                (this.isActive = !0),
                t.scrollHeight === t.clientHeight || (this.pane.outerHeight(!0) >= t.scrollHeight && s !== _)
          ...
          (h.prototype.scrollBottom = function (t) {
            return this.isActive
              ? (this.$content.scrollTop(this.contentHeight - this.$content.height() - t).trigger(m),
                this.stop().restore(),
                this)
              : void 0;
          }),
          (h.prototype.scrollTop = function (t) {
            return this.isActive
              ? (this.$content.scrollTop(+t).trigger(m), this.stop().restore(), this)
              : void 0;
          }),
          ...
          (h.prototype.stop = function () {
            return (
              E && this.scrollRAF && (E(this.scrollRAF), (this.scrollRAF = null)),
              (this.stopped = !0),
              this.removeEvents(),
          ...
          (h.prototype.destroy = function () {
            return (
              ...
              this.$el.hasClass("has-scrollbar") &&
                (this.$el.removeClass("has-scrollbar"), this.$content.css({ right: "" })),
              this
            );
          }),
      ...
      (t.fn.nanoScroller = function (e) {
        return this.each(function () {
          var i, n;
          if (
            ((n = this.nanoscroller) || ((i = t.extend({}, C, e)), (this.nanoscroller = n = new g(this, i))),
            e && "object" == typeof e)
          ) {
    ...
    function d() {
      ...
      function e(t, e) {
        ...
        T.set(i, { x: t ? "15%" : "-15%", opacity: 0, display: "block" }, 0.1),
          ...
          T.staggerTo(n, 0.2, { x: t ? "-15%" : "15%", opacity: 0 }, 0.03, function () {
            n.css("display", "none");
          });
      }
      var i = this,
      ...
      function i() {
        for (var t = 0; t < s.length; t++) {
          var e = s[t],
            i = 0,
            n = A;
          e.$block.length && ((i = e.$block.offset().top), (n = e.$block.innerHeight())),
            (e.activate = i - A / 2),
            ...
            n.length &&
              n.on("click", "[data-filter]", function (t) {
                ...
                b(this).addClass("active").siblings().removeClass("active"),
                  i.isotope({ filter: "*" === e ? "" : "[data-filter*=" + e + "]" });
              });
        }),
          C.on("click", '[href="#nk-toggle-filter"]:not(.busy)', function (t) {
            ...
            if (e.length && n.length)
              if ((t.preventDefault(), t.stopPropagation(), e.addClass("busy"), r))
                T.staggerTo(n.children(), 0.2, { y: -10, opacity: 0 }, 0.04, function () {
                  T.to(n, 0.4, {
                    height: 0,
                    marginBottom: 0,
                    marginTop: 0,
                ...
                n.css("height", 0),
                  ...
                  T.to(n, 0.4, {
                    ...
                    display: "block",
                    onComplete: function () {
                      T.staggerTo(n.children(), 0.2, { y: 0, opacity: 1 }, 0.04, function () {
